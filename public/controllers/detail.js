angular
  .module('app')
  .controller('DetailController', _DetailController);

_DetailController.$inject = ['$scope', '$rootScope', '$routeParams', 'Show', 'Subscription'];

function _DetailController($scope, $rootScope, $routeParams, Show, Subscription) {
  Show.get({
    _id: $routeParams.id
  }, function(show) {
    $scope.show = show;
